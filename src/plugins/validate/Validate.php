...
class Validate
{
     ...
     * @return $this
     */
    public function extend(string $type, callable $callback = null, string $message = null): static
    {
     ...
     * @return void
     */
    public function setTypeMsg(array|string $type, string $msg = null): void
    {
        if (is_array($type)) {
     ...
     * @return $this
     */
    public function failException(bool $fail = true): static
    {
     ...
     * @param  mixed|null  $rule  验证规则 true 移除所有规则
     * @return $this
     */
    public function remove(array|string $field, mixed $rule = null)
    {
        if (is_array($field)) {
     ...
     *
     * @param  array|string  $field 字段名
     * @param  mixed|null  $rule  验证规则
     * @return $this
     */
    public function append(array|string $field, mixed $rule = null)
    {
        if (is_array($field)) {
            foreach ($field as $key => $rule) {
     ...
     * @return bool
     */
    public function checkRule(mixed $value, mixed $rules): bool
    {
     ...
     * @return bool
     */
    public function is(mixed $value, string $rule, array $data = []): bool
    {
        switch (static::camel($rule)) {
            case 'require':
                // 必须
     ...
     * @return bool
     */
    public function dateFormat(mixed $value, mixed $rule): bool
    {
     ...
     * @return bool
     */
    public function requireIf(mixed $value, mixed $rule, array $data = []): bool
    {
     ...
     * @return bool
     */
    public function requireWith(mixed $value, mixed $rule, array $data = []): bool
    {
     ...
     * @return bool
     */
    public function notIn(mixed $value, mixed $rule): bool
    {
        return ! in_array($value, is_array($rule) ? $rule : explode(',', $rule));
    }
     ...
     * @return bool
     */
    public function between(mixed $value, mixed $rule): bool
    {
        if (is_string($rule)) {
            $rule = explode(',', $rule);
        }
     ...
     * @return string|array
     */
    protected function parseErrorMsg(string $msg, mixed $rule, string $title)
    {
     ...
     * @return array
     */
    protected function errorMsgIsArray(array $msg, mixed $rule, string $title)
    {
